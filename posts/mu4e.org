...
*** Tags
    ...
    differently over the years. Many tools map tags with folders (Maildir
...
*** *mbsync* - synchronise [[https://en.wikipedia.org/wiki/Maildir#:~:text=From%20Wikipedia%2C%20the%20free%20encyclopedia,are%20added%2C%20moved%20and%20deleted.][Maildir]] mailboxes using IMAP4
    ...
    #+begin_src shell
      C: 6/7  B: 47/58  M: +0/0 *0/0 #0/0  S: +3/3 *0/0 #0/0
      Maildir notice: no UIDVALIDITY, creating new.
      C: 6/7  B: 48/58  M: +0/0 *0/0 #0/0  S: +29/29 *0/0 #0/0
      Maildir notice: no UIDVALIDITY, creating new.
      C: 6/7  B: 49/58  M: +0/0 *0/0 #0/0  S: +43/43 *0/0 #0/0
      Maildir notice: no UIDVALIDITY, creating new.
      C: 6/7  B: 50/58  M: +0/0 *0/0 #0/0  S: +43/43 *0/0 #0/0
      Maildir notice: no UIDVALIDITY, creating new.
      C: 6/7  B: 51/58  M: +0/0 *0/0 #0/0  S: +49/49 *0/0 #0/0
      Maildir notice: no UIDVALIDITY, creating new.
      C: 6/7  B: 52/58  M: +0/0 *0/0 #0/0  S: +92/92 *0/0 #0/0
      Maildir notice: no UIDVALIDITY, creating new.
      C: 6/7  B: 53/58  M: +0/0 *0/0 #0/0  S: +92/92 *0/0 #0/0
      Maildir notice: no UIDVALIDITY, creating new.
      C: 6/7  B: 54/58  M: +0/0 *0/0 #0/0  S: +92/92 *0/0 #0/0
      Maildir notice: no UIDVALIDITY, creating new.
      C: 6/7  B: 55/58  M: +0/0 *0/0 #0/0  S: +92/92 *0/0 #0/0
      Maildir notice: no UIDVALIDITY, creating new.
      C: 6/7  B: 56/58  M: +0/0 *0/0 #0/0  S: +92/92 *0/0 #0/0
      Maildir notice: no UIDVALIDITY, creating new.
      C: 6/7  B: 57/58  M: +0/0 *0/0 #0/0  S: +92/92 *0/0 #0/0
      Maildir notice: no UIDVALIDITY, creating new.
      C: 7/7  B: 58/58  M: +0/0 *0/0 #0/0  S: +92/92 *0/0 #0/0
    #+end_src
